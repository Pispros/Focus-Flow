...
import { initDatabase } from "@/services/app.service";
...
export default function FocusFlowWelcome() {
      ...
      <View style={styles.main}>
        ...
        <View style={styles.logoSection}>
          ...
          <View style={styles.logoCircle}>
            <Timer size={64} color={Colors["dark"].primary} />
          </View>
        </View>
        ...
        <View style={styles.featuresContainer}>
          ...
          <TouchableOpacity
            ...
            <ArrowRight size={24} color={Colors["dark"].background} />
