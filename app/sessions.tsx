  ...
  const renderSessionItem = ({ item: session }: { item: Session }) => (
    <View style={styles.sessionItem}>
      ...
      <TouchableOpacity
        ...
        <Trash2 size={18} color={Colors["dark"].zinc500} />
      </TouchableOpacity>
    </View>
  );
    ...
    <View style={styles.dateGroup}>
      <View style={styles.dateHeader}>
        <View style={styles.dateLeft}>
          <Calendar size={16} color={Colors["dark"].zinc400} />
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backBtn} onPress={() => router.back()}>
          <ArrowLeft size={24} color={Colors["dark"].zinc50} />
        </TouchableOpacity>
      ...
      {filteredSessions.length === 0 ? (
        <View style={styles.emptyState}>
          <Clock size={48} color={Colors["dark"].zinc500} />
